#ifndef C_CPP_ARRAYADTCPP_H
#define C_CPP_ARRAYADTCPP_H
...
//int Array::RBinSearch(int a[], int low, int high, int key){
//    int mid = 0;
//    if(low <= high){
